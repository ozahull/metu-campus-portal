      ...
      {lightbox !== null && photos[lightbox] && (
        ...
        >
          <button
            ...
            onClick={() => setLightbox(null)}
            className="absolute top-4 right-4 inline-flex size-10 items-center justify-center rounded-full bg-background/20 text-background hover:bg-background/30"
          >
            <X className="size-5" />
          </button>
          {photos.length > 1 && (
            <>
              <button
                ...
                className="absolute left-2 inline-flex size-11 items-center justify-center rounded-full bg-background/20 text-background hover:bg-background/30 sm:left-4"
              >
              ...
              <button
                ...
                className="absolute right-2 inline-flex size-11 items-center justify-center rounded-full bg-background/20 text-background hover:bg-background/30 sm:right-4"
              >
